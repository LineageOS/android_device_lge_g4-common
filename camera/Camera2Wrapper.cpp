...
const static char * iso_values[] = {"auto,ISO_HJR,ISO50,ISO100,ISO150,ISO200,ISO250,ISO300,ISO350,ISO400,ISO800,ISO1600,ISO2700,ISO3200","auto"};
...
static char * camera2_fixup_getparams(int id, const char * settings)
{
    ...
    if (!videoMode) {
        ...
        if (params.get("hdr-mode")) {
            if(!strncmp(params.get("hdr-mode"),"1",1)) {
...
static char * camera2_fixup_setparams(int id __unused, const char * settings)
{
    ...
    if(params.get(android::CameraParameters::KEY_ISO_MODE)) {
        ...
        if(strcmp(isoMode, "ISO_HJR") == 0) {
            ...
            params.set(android::CameraParameters::KEY_LGE_ISO_MODE, "1600");
