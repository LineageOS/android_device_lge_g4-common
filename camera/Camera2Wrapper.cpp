...
const static char * iso_values[] = {"auto,ISO50,ISO100,ISO150,ISO200,ISO250,ISO300,ISO350,ISO400,ISO800,ISO1600,ISO2700","auto"};
...
static char * camera2_fixup_setparams(int id __unused, const char * settings)
{
    ...
    if(params.get(android::CameraParameters::KEY_ISO_MODE)) {
        ...
        if(strcmp(isoMode, "ISO50") == 0)
            ...
            params.set(android::CameraParameters::KEY_ISO_MODE, "150");
        else if(strcmp(isoMode, "ISO200") == 0)
            params.set(android::CameraParameters::KEY_ISO_MODE, "200");
        else if(strcmp(isoMode, "ISO250") == 0)
            params.set(android::CameraParameters::KEY_ISO_MODE, "250");
        else if(strcmp(isoMode, "ISO300") == 0)
            params.set(android::CameraParameters::KEY_ISO_MODE, "300");
        else if(strcmp(isoMode, "ISO350") == 0)
            params.set(android::CameraParameters::KEY_ISO_MODE, "350");
            ...
            params.set(android::CameraParameters::KEY_ISO_MODE, "2700");
    }
